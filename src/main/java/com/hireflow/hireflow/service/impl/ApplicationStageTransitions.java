...
/**
 * Allowed forward transitions for HR-driven stage updates. REJECTED is reachable from
 * any non-terminal stage; HIRED and REJECTED are terminal.
 */
final class ApplicationStageTransitions {
    ...
    private static final Map<ApplicationStage, Set<ApplicationStage>> ALLOWED = Map.of(
            SCREENING, EnumSet.of(INTERVIEW_SCHEDULED, REJECTED),
